...
def extract_email_content(msg_file):
    # Open the .msg file
...
msg_file_path = "/content/outlookSample.msg"

# Extract email content
extract_email_content(msg_file_path)

msg_file = "/content/outlookSample.msg"  # Provide your .msg file path
...
def extract_email_content(msg_file):
    ...
    # Extract body content (text or HTML)
    if msg.htmlBody:
        email_body = msg.htmlBody
        body_type = "HTML"
        # Optionally clean the HTML (e.g., remove tags)
